...
public class EmotionApiActivity extends AppCompatActivity {
    ...
    // when the "GET REAL TIME EMOTION" Button is clicked this function is called
    public void getrealtimeEmotion(View view) {
        // run the GetEmotionCall class in the background
        //GetEmotionCall emotionCall = new GetEmotionCall(imageView);
       // emotionCall.execute();

        Intent t= new Intent(EmotionApiActivity.this,EmotionApiActivity.class);
        startActivity(t);
    ...
    private void requestPermission() {
        ActivityCompat.requestPermissions(EmotionApiActivity.this,new String[]{READ_EXTERNAL_STORAGE}, REQUEST_PERMISSION_CODE);
    }
    ...
    private class GetEmotionCall extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... params) {
            ...
            try {
                ...
                request.setHeader("Ocp-Apim-Subscription-Key", "228971f008f9413da3940d7c10ad9c29");
