...
public class ContactSelectActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(eu.kudan.kudansamples.R.layout.activity_contacts);

        button1 = (Button) findViewById(eu.kudan.kudansamples.R.id.button1);
        button2 = (Button) findViewById(eu.kudan.kudansamples.R.id.button2);
        button3 = (Button) findViewById(eu.kudan.kudansamples.R.id.button3);
        button4 = (Button) findViewById(eu.kudan.kudansamples.R.id.button4);
        button5 = (Button) findViewById(eu.kudan.kudansamples.R.id.button5);
        saveButton = (Button) findViewById(eu.kudan.kudansamples.R.id.save_button);

        textView1 = (TextView) findViewById(eu.kudan.kudansamples.R.id.textview1);
        textView2 = (TextView) findViewById(eu.kudan.kudansamples.R.id.textview2);
        textView3 = (TextView) findViewById(eu.kudan.kudansamples.R.id.textview3);
        textView4 = (TextView) findViewById(eu.kudan.kudansamples.R.id.textview4);
        textView5 = (TextView) findViewById(eu.kudan.kudansamples.R.id.textview5);
    ...
    void addNewContact(Contact contact, int viewNumber) {
        ...
        if(!textViewList[viewNumber-1].getText().toString().equals(
                getResources().getString(eu.kudan.kudansamples.R.string.no_contact_selected_textview))) {
