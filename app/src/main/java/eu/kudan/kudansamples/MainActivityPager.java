...
public class MainActivityPager extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(eu.kudan.kudansamples.R.layout.activity_main_pager);

        viewPager = (ViewPager) findViewById(eu.kudan.kudansamples.R.id.viewpager);
        viewPager.setAdapter(new PagerAdapterMainActivity(getSupportFragmentManager()));

        tabLayout = (TabLayout) findViewById(eu.kudan.kudansamples.R.id.sliding_tabs);
    ...
    protected void onStart() {
        ...
        SharedPreferences sharedPref = getSharedPreferences(getString(eu.kudan.kudansamples.R.string.password),
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(eu.kudan.kudansamples.R.menu.menu_main, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == eu.kudan.kudansamples.R.id.action_setting) {
