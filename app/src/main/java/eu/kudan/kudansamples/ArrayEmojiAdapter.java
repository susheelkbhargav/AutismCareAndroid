...
public class ArrayEmojiAdapter extends ArrayAdapter<Emoji> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(getContext()).inflate(eu.kudan.kudansamples.R.layout.item_emoji, parent, false);
        }
        // Lookup view for data population
        ImageView ivEmoji = (ImageView) convertView.findViewById(eu.kudan.kudansamples.R.id.ivItemEmoji);
