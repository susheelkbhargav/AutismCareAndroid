...
public class AIDialog {
    ...
    public AIDialog(final Context context, final AIConfiguration config) {
        this(context, config, ai.kudan.R.layout.aidialog);
    }
    ...
    public AIDialog(final Context context, final AIConfiguration config, final int customLayout) {
        ...
        partialResultsTextView = (TextView) dialog.findViewById(ai.kudan.R.id.partialResultsTextView);

        aiButton = (AIButton) dialog.findViewById(ai.kudan.R.id.micButton);
